        ...
        <div className="py-14 flex">
            ...
            <div id="controls-carousel" className="relative w-2/3" data-carousel="static" style={{ margin: '80px' }}>
                ...
                <button type="button" className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                    <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/50 dark:bg-gray-800/50 hover:bg-white dark:hover:bg-gray-800 group-hover:bg-purple-500 dark:group-hover:bg-purple-700 group-focus:ring-4 group-focus:ring-purple-500 dark:group-focus:ring-purple-700 group-focus:outline-none">
                        <svg className="w-6 h-6 text-gray-800 dark:text-white group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
